...
def writeScore(score):
    myfont = pygame.font.Font('BAUHS93.TTF', 20)  # 한글 폰트
    txt = myfont.render(u'Score Count : ' + str(score), True, (255 - r, 255 - g, 255 - b))
...
## 전역 변수 선언 부분 ##
r, g, b = [0] * 3  # 게임 배경색 색의속석 3요소 가상혼하 색상(색조, 채도,명도)
...
monsterImage = ['monster01.png', 'monster02.png', 'monster03.png', 'monster04.png', \
                'monster05.png', 'monster06.png', 'monster07.png', 'monster08.png', 'monster09.png', 'monster10.png']
monster = None  # 우주괴물
...
shipSize = ship.get_rect().size  # 가로 세로 (0,1)
